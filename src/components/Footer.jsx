...
const StyledP = styled.p`
  ...
  &.event {
    ...
    text-shadow: ${({isClicked}) => (isClicked ? "0 0 8px rgba(255, 255, 255, 0.8)" : "none")};
  }
`;
  ...
  return (
    <Container>
      <Top>
        ...
        <Icons>
          <StyledLink to="https://www.instagram.com/cpu_jbnu/">
            <Insta />
          </StyledLink>
          <StyledLink to="https://github.com/JBNU-CPU">
            <Github />
          </StyledLink>
        </Icons>
      </Top>
      <Main>
        ...
        <Bottom>
          <Copyright>
            Copyright <Copy /> CPU All Rights Reserved.
          </Copyright>
          <Copyright>Created by 김동준, 백서영, 박도현, 안현, 김지훈</Copyright>
        </Bottom>
      </Main>
    </Container>
  );
