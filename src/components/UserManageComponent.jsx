...
const UserManagementComponent = ({apiEndpoint}) => {
  ...
  return (
    <Container>
      {/* 🔹 검색 입력 필드 추가 */}
      <SearchInput type="text" placeholder="이름 또는 학번 검색" value={searchTerm} onChange={handleSearchChange} />

      {error && <p style={{backgroundColor: "#1b1d25", color: "red", textAlign: "center"}}>{error}</p>}
      {loading && <p style={{backgroundColor: "#1b1d25", textAlign: "center", color: "white"}}>데이터 로딩 중...</p>}
